...
options:
-t, --tag TAG           Specify a name/tag for the docker image. Default: opera-adt/tropo:latest
...
echo "docker run --rm -it $image_name opera_tropo --help"
#
echo "To run on a PGE runconfig:"
echo "docker run --user \$(id -u):\$(id -g) -v \$PWD:/work --rm -it $image_name opera_tropo run runconfig.yaml"
# where...
